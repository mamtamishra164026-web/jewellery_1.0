  ...
  return (
    <section className="w-full bg-[#7A153B] py-4 px-4 sm:px-6 lg:px-8">
      ...
      <div className="max-w-7xl mx-auto my-2 rounded-3xl overflow-hidden bg-[#330D3A] border border-pink-900/30 shadow-[0_25px_60px_-15px_rgba(0,0,0,0.7)] p-6 sm:p-10 lg:p-12 relative flex flex-col lg:flex-row items-center justify-between gap-8 lg:gap-12">
        ...
        <div className="flex-1 space-y-6 text-left w-full relative z-10">
          ...
          >
            <span className="text-[10px] font-bold tracking-widest text-[#F39C12] uppercase bg-[#2A082D]/90 border border-[#F39C12]/40 rounded-full px-4 py-1.5 shadow-md inline-flex items-center gap-1.5">
              <span className="text-[#F39C12]">✦</span> ROYAL BRIDAL COUTURE COLLECTION
            </span>
          </motion.div>
          ...
          <div className="space-y-4">
            ...
            >
              Elevate Your Wedding Day <br />
              <span className="italic font-normal text-[#F39C12]">Bridal Grace & Glamour</span>
            </motion.h1>
            ...
            >
              Discover handcrafted golden Kaleeras, traditional Punjabi Choodas, grand Kundan & Polki bridal sets, and exquisite hair accessories tailored for every royal bride.
            </motion.p>
          </div>
        ...
        <div className="flex-shrink-0 w-full lg:max-w-[400px] aspect-[4/3] xs:aspect-[16/10] lg:aspect-[4/5] relative flex items-center justify-center relative z-10">
          <div 
            onClick={() => navigate(`/products/${currentSlide.productId}`)}
          ...
          >
            ...
            <div className="relative z-10 text-white p-2">
              <AnimatePresence mode="wait">
                ...
                >
                  <span className="text-[9px] font-bold tracking-widest uppercase text-[#F39C12]">{currentSlide.label}</span>
                  <h3 className="text-xl font-serif font-bold tracking-tight text-white mt-0.5">{currentSlide.title}</h3>
                </motion.div>
              </AnimatePresence>
            </div>
          </div>
